...
// camera
Camera camera(glm::vec3(58.3904f, 5.19683f, -37.5486f));
...
int main()
{
    ...
    // load models
    Model ourModel("model/sincielo/sincielo.obj");
    ...
    camera.MovementSpeed = 20; //Optional. Modify the speed of the camera
